# Eenvoudige versie van Atari Pong
# Gebruikt Pygame library
# Speler 1: W,S
# Speler 2: Up,Down
...
def draw(canvas):
    ...
    label1 = myfont1.render("Speler 1: "+str(l_score), 1, (255,255,0))
    canvas.blit(label1, (30,20))

    myfont2 = pygame.font.SysFont("Comic Sans MS", 20)
    label2 = myfont2.render("Speler 2: "+str(r_score), 1, (255,255,0))
